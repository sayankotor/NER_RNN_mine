...
if __name__ == "__main__":
    ...
    parser.add_argument('--isElmo', type=str2bool, default=False, help='Show additional information.', nargs='?',
                        choices=['yes', True, 'no(default)', False])
    parser.add_argument('--elmo_weights', default='/home/vika/NER_RNN/targer/embeddings/elmo_2x4096_512_2048cnn_2xhighway_5.5B_weights.hdf5', help='Path to elmo weights hdf5 file.')
    
    parser.add_argument('--elmo_options', default='/home/vika/NER_RNN/targer/embeddings/elmo_2x4096_512_2048cnn_2xhighway_5.5B_options.json', help='Path to elmo options json.')
    ...
    if args.load is None:
        ...
        tagger = TaggerFactory.create(args, word_seq_indexer, tag_seq_indexer, tag_sequences_train, args.isElmo, weight_file = args.elmo_weights, options_file = args.elmo_options)
    else:
