...
class TaggerFactory():
    ...
    @staticmethod
    def create(args, word_seq_indexer, tag_seq_indexer, tag_sequences_train, elmo, weight_file, options_file):
        if args.model == 'BiRNN':
            tagger = TaggerBiRNN(word_seq_indexer=word_seq_indexer,
                                 ...
                                 gpu=args.gpu, useElmo = elmo, weight_file=weight_file, options_file = options_file)
            ...
            tagger = TaggerBiRNNCNN(word_seq_indexer=word_seq_indexer,
                                    ...
                                    char_window_size=args.char_window_size, useElmo = elmo, weight_file = weight_file, options_file = options_file)
